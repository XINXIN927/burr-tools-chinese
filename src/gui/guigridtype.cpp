...
const char * guiGridType_c::getName(void) const {
  switch(gt->getType()) {
    case gridType_c::GT_BRICKS: return "方块";
    case gridType_c::GT_TRIANGULAR_PRISM: return "三棱柱";
    case gridType_c::GT_SPHERES: return "球体";
    case gridType_c::GT_RHOMBIC: return "菱形四面体";
    case gridType_c::GT_TETRA_OCTA: return "四面体-八面体";
    default: return 0;
  }
}
